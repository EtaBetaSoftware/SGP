...
Nella fase attuale il mercato presenta un elevato livello di dinamismo, è incline a continui cambiamenti e contiene un numero potenzialmente alto di \inglese{competitor}. È in una tale prospettiva che le imprese puntano al potenziamento del \mktg \inglese{online} affidandosi al \inglese{know how} di \customer.

Pur essendo quest'ultima una realtà consolidata con un fatturato annuo che, a dispetto delle ridotte dimensioni dell'organico che conta soltanto tre unità, ammonta a \EUR{200.000}, un'analisi interna all'azienda ha permesso di mettere in luce dei margini di miglioramento legati alla gestione dei processi aziendali e allo sviluppo di nuove \inglese{skill} nell'ambito della gestione dei progetti da parte del personale.
...
Tale dato, riduce di molto il \inglese{target} effettivo di clienti che si rivolge ad aziende specializzate nel settore del \mktg , come \customer .
...
\centering
\rowcolors{1}{black!1}{black!10}
\begin{tabular}{p{.6\textwidth}D{,}{,}{3}}
\toprule
\textbf{\sffamily{}Attività} & \multicolumn{1}{c}{\textbf{\sffamily{}Costo preventivato}}\\
\midrule
 ...
 corso di \inglese{Quality Assurance}                & 7.000,00\,\text{\euro} \\
\bottomrule
\end{tabular}
