...
Occorre tuttavia tenere presente che nel mercato vi sono \sw distribuiti con una licenza \inglese{open source} e gratuiti, come \swname{Bonitasoft}, che sono in grado di gestire situazioni molto complesse e offrono numerose funzionalità anche di alto livello come parte del pacchetto di base per cui non è necessario sostenere alcun costo di acquisizione.
 
I \inglese{leader} del mercato, in particolare quello legato alle soluzioni \sw a pagamento, sono grandi colossi come \swname{IBM}, \swname{Oracle} o \swname{Microsoft}. Tali organizzazioni hanno compreso fin da subito la necessità di offrire alle aziende \sw per la gestione di processi e si sono affermate nel tempo offrendo soluzioni con funzionalità ad alto livello che permettono anche l'interazione con \sw di terze parti.
...
\swname{HP} è presente nel mercato con prodotti come \swname{HP Business Decision Applicance} e \swname{HP Data Warehouse Appliance} orientati principalmente alle gestione delle informazioni aziendali e all'\inglese{data mining} al fine di facilitare le attività di \inglese{decision making}, integrandosi strettamente con i prodotti \swname{Microsoft} più diffusi per la memorizzazione delle informazioni, come \swname{Microsoft SQL Server}.
...
Nel campo della \bsn \inglese{intelligence} sono state particolarmente signficative le acquisizioni di \swname{Lotus} nel 1995, \swname{Lombardi} nel 2005, \swname{MRO} (marchio \swname{Tivoli}) nel 2006 e \swname{Cognos} nel 2008. Il \inglese{portfolio} soluzioni della divisione \swname{IBM Software Group} comprende allo stato attuale \inglese{brand} fra i quali si menzionano \swname{Information Management}, \swname{Lotus}, \swname{Rational}, \swname{Tivoli}, \swname{WebSphere} e \swname{Product Lifecycle Management}.
...
Un esempio dell'interoperabilità tra le soluzioni offerte e applicazioni di terze parti è rappresentato da \swname{Bonita Open Solution} che permette, sottoscrivendo un abbonamento di tipo `\textsf{efficiency}', l'interfacciamento con applicativi \swname{SAP}.
...
\item modulo \swname{User Experience} per disporre di due tipologie di interfacciamento (utente semplice e amministratore);
...
\item per interfacciarsi con applicativi gestionali \swname{SAP} tramite gli appositi connettori.
\end{itemize}
\end{itemize} 
...
\begin{thebibliography}{90}
  \bibitem[Mazzolari, 2007]{mazzolari:bpmita} Mazzolari, F. e Testolin, G., \emph{Document Management}, SistemiNEWS, 2007, \url{http://www.arxivar.it/download/doc_download/99-e-document-management} [data di consultazione 11 luglio 2013]
\end{thebibliography}
