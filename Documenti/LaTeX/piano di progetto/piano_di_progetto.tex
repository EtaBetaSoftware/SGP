...
\begin{figure}[H]
  \centering
  \includegraphics[width=.8\textwidth]{camunda_tasklist}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=.8\textwidth]{camunda_cockpit}
...
indicatori grafici stato di avanzamento      & \cross & \tick  &   ¿?    & \cross \\
ottimizzazione dei processi                  & \tick$^{*}$ & \cross & ¿?       & \cross \\
...
esecuzione automatizzata processi            & \tick  & \tick  &   ¿?  & \tick \\
integrazione con \sw di parti terze          & \tick  & \tick  &   \tick     & \tick \\
interfacciamento con utenti                  & \tick  & \tick  &    ¿?    & \tick \\
\inglese{form} statici                       & \tick  & \tick  &    ¿?    & \cross \\
\inglese{form} dinamici                      & \tick$^{*}$ & \tick  &¿?        & \cross \\
\inglese{form} internazionalizzabili         & \tick$^{*}$ & \cross &   ¿?     & \cross \\
