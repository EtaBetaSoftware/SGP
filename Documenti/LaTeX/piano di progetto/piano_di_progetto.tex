...
\progname supporta l'integrazione con altre applicazioni, in particolare, tra le più importanti troviamo l'integrazione con gli ECM come \swname{Sharepoint} e con gestionali CRM.
...
sistema di \inglese{reporting}               & \tick  & \tick  &  \tick    &      \\
...
\inglese{form} internazionalizzabili         & \tick$^{*}$ & \cross &   ¿?     &      \\
gestione separata dei ruoli                  & \tick$^{*}$  & \cross & \cross       &      \\
\bottomrule
