...
\item Per quanto riguarda invece, la gestione della lingua, l' italiano è offerto come funzionalità nativa del \sw \progname. Tuttavia, la localizzazione in lingua italiana non è completa e diverse parti risultano essere tradotte male o non tradotte.

\item \progname permette la simulazione dei processi. In seguito ai test eseguiti, però, risulta essere più deludente rispetto a quella offerta da altri \sw precedentemente verificati.
