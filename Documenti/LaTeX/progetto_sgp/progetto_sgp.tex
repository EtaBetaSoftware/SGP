...
Il sistema di \inglese{reporting} è ben strutturato, restituisce un documento sia in formato \texttt{.pdf} che in \texttt{xls}. Tuttavia, il \sw fornisce il \inglese{report} in solo lingua inglese.
