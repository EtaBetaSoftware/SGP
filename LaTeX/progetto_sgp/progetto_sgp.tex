...
\begin{longtable}{p{.6\textwidth}lr}
\toprule
\bfseries\sffamily{}Intervento & \bfseries\sffamily{} Autore & \multicolumn{1}{l}{\bfseries\sffamily{} Data}\\
\midrule
verifica della  sez. 3 (`Proposta') & \ele & 19 luglio 2013\\
verifica della  sez. 2.3.3 (`Analisi comparativa') & \ele & 19 luglio 2013\\
verifica della  sez. 2.2.4 (`Camnunda BPM') & \ele & 19 luglio 2013\\
verifica della  sez. 2.2.3 (`Bizagi') & \die & 19 luglio 2013\\
verifica della  sez. 2.2.2 (`ProcessMaker') & \ele & 19 luglio 2013\\
verifica della  sez. 2.2.1 (`Bonita BPM') & \die & 19 luglio 2013\\
verifica della sez. 1 (`Introduzione') & \die & 19 luglio 2013\\
verifica delle sez. 2.1.4 (`Prospettiva temporale') e 2.1.5 (`Analisi geotopografica') & \ele & 19 luglio 2013\\
verifica della sez. 2.1.3 (`Cosa offre il mercato') & \die & 19 luglio 2013\\
verifica delle sez. 2.1.2 (`Vantaggi') & \ele &  19 luglio 2013\\
verifica della sez. 2.2.1 ('Cosa sono i \sw BPM') & \die & 18 luglio 2013\\
verifica della sez. 2.1 ('Introduzione') & \die & 18 luglio 2013\\
verifica della sez. 1.3 (`Gestione dei Rischi') & \die & 18 luglio 2013\\
verifica della sez. 1.2 (`Aspetto Economico') & \ele &  18 luglio 2013\\
verifica della sezione 1.1 (`Pianificazione')  & \die & 18 luglio 2013\\
redazione della  sez. 3 (`Proposta') & \die & 17 luglio 2013\\
redazione sez. 2.3.3 (`Analisi comparativa') & \ele & 17 luglio 2013 \\
stesura della  sez. 2.3 (`Software selezionati') & \die & 16 luglio 2013\\
redazione della  sez. 2.2.4 (`Camunda BPM') & \die & 15 luglio 2013\\
stesura della  sez. 2.2.3 (`Bizagi') & \ele & 13 luglio 2013\\
redazione della  sez. 2.2.2 (`ProcessMaker') & \die & 12 luglio 2013\\
stesura della  sez. 2.2.1 (`Bonita BPM') & \ele & 10 luglio 2013\\
redazione delle sez. 2.2.4 (`Prospettiva temporale') e 2.1.5 (`Analisi geotopografica') & \die & 6 luglio 2013\\
stesura della sez. 2.2.3 (`Cosa offre il mercato') & \ele & 6 luglio 2013\\
redazione della sez. 2.2.2 (`Vantaggi') & \die &  5 luglio 2013\\
stesura delle sez. 2.1 (`Introduzione') e 2.2.1 ('Cosa sono i \sw BPM') & \ele & 5 luglio 2013\\
...
stesura scheletro del documento & \die & 1 luglio 2013\\
\bottomrule
\end{longtable}
...
La scomposizione avviene secondo una struttura gerarchica: il lavoro viene dapprima suddiviso in una serie di attività di primo livello che vengono a loro volta scomposte in sotto-attività di secondo livello di dimensioni più piccole e semplici da gestire, dette \inglese{Work Package} (WP).
...
La WBS, infine, offre una chiara visione del prodotto finale e del processo complessivo attraverso il quale è stato creato il prodotto. Di seguito si presenta la definizione della WBS per il progetto BPM-1.0. 

Il \inglese{team} ha scelto di strutturare la WBS seguendo il ciclo di vita del progetto, individuando in primo luogo tre attività di primo livello che corrispondono alla Pianificazione, allo Studio di Mercato e alla Proposta, come illustrato dal diagramma riportato in \figurename~\vref{fig:WBS}. 
...
\paragraph{\bfseries\sffamily{}Studio dei \sw esistenti }
\begin{description}
\item{\bfseries Descrizione:}\\
...
\begin{enumerate}
	...
	\end{enumerate}
\item{\bfseries Costo:} \text{\euro} 1.000,00 
...
\begin{enumerate}
  \item valutazione generale del rispetto dei requisiti posti da \customer;
	\item valutazione dei costi e dei benefici della creazione di una soluzione \sw \inglese{ad hoc}.
\end{enumerate}
...
\centering
\rowcolors{1}{black!1}{black!10}
\begin{tabular}{p{.12\textwidth}p{.6\textwidth}}
\toprule
...
\begin{description}
	...
	Durante la realizzazione del progetto è probabile che alcuni membri del \inglese{team} siano soggetti a problemi fisiologici e/o sovvengano impegni personali improrogabili che porterebbero ad una sicura modifica della pianificazione del lavoro collettivo.
...
\begin{description}
	\item{\scshape\bfseries Analisi:}\\
	Per ovvie ragioni di inesperienza da parte di tutto il \inglese{team} buona parte delle competenze tecnologiche richieste per la realizzazione del progetto risultano sconosciute.
...
\begin{description}
	\item{\scshape\bfseries Analisi:}\\
	L'errata pianificazione del lavoro fa parte dell'ovvia inesperienza del \inglese{team}, e in particolare di chi ricopre il ruolo di \inglese{Project Manager}. Tali errori possono portare ad uno sbilanciamento dei costi (sia in eccesso che in difetto) che andrà ad incidere sul bilancio finale.
	\item{\scshape\bfseries Probabilità:} \med
	\item{\scshape\bfseries Impatto:} 3 
	\item{\scshape\bfseries Strategia di Gestione:}\\
...
\begin{figure}[H]
  \centering
  \includegraphics[width=.5\textwidth]{bpmcycle}
...
Fra le altre società presenti sul mercato, vale la pena di menzionare \swname{SAP}, \swname{Fujistu} e \swname{HP}. \swname{SAP} è presente con soluzioni di \inglese{data warehousing} come \swname{SAP HANA} e \swname{Sybase IQ} e \sw di monitoraggio e notifica dei processi aziendali (\swname{SAP BusinessObjects Event Insight}) attraverso il controllo degli indicatori di processo  e accordi sul livello di servizio (di tipo prestazionale).
...
\begin{figure}[H]
  \centering
  \includegraphics[width=.75\textwidth]{tipologie}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=.75\textwidth]{mercato_2000}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=.75\textwidth]{mercato_2012}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=.7\textwidth]{markettrend}
...
\renewcommand{\labelenumii}{\arabic{enumi}.\arabic{enumii}}
  \item modellazione
 	\begin{enumerate}
	  \item modellazione tramite \inglese{editor} grafico
	  \item rispetto di notazioni \inglese{standard}
	  \item riutilizzo processi da adattare
	  \item \inglese{template} di processi
	\end{enumerate}
	\item monitoraggio delle attività di processo (BAM)
		\begin{enumerate}
	...
	\begin{enumerate}
	  ...
	  \item facilità utilizzo del \inglese{designer}
	\end{enumerate}
...
I tre moduli grafici permettono, rispettivamente, di modellare i processi esistenti mediante un \inglese{editor} di flussi di lavoro (\swname{Bonita Studio}), di realizzare dei \inglese{form} personalizzati a supporto dello svolgimento delle attività codificate nell'\inglese{editor} dei processi (\swname{Bonita Form Builder}) e, infine, dal modulo \swname{Bonita User Experience} che permette di visualizzare per ciascun soggetto coinvolto nella realizzazione di un processo delle attività da svolgere.
...
\begin{figure}[H]
  \centering
  \includegraphics[width=.65\textwidth]{bonita_architecture}
...
Inoltre, l'\inglese{editor} grafico offerto da \progname, rispetta lo \inglese{standard} BPMN 2.0 per la rappresentazione dei flussi di lavoro. L'uso dello \inglese{standard} è molto importante perché permette una comunicazione molto più completa e priva di ambiguità, anche con altri operatori del settore.

Grazie all'interoperabilità tra strumenti di diversi fornitori garantita dal rispetto degli \inglese{standard}, è possibile diminuire gli eventuali costi di riconversione in una futura migrazione verso altre soluzioni.
...
Il sistema \progname comprende nel pacchetto di base, la funzionalità di simulazione dei processi. La simulazione è molto importante perché permette ai responsabili del processo decisionale, soprattutto se poco esperti, di avere una percezione sull'andamento ottimale dei processi.

In questo modo si potrà monitorare e controllare la situazione possedendo un metro di confronto. Si riporta in figura \ref{fig:simulazione} un estratto del \inglese{report} derivante dalla simulazione di un processo.

\begin{figure}[H]
  \centering
  \includegraphics[width=.6\textwidth]{simulazione}
...
Il sistema di \inglese{reporting} è ben strutturato, restituisce un documento sia in formato \texttt{.pdf} che in \texttt{xls}. Tuttavia, il \sw fornisce il \inglese{report} in solo lingua inglese. Il sistema supporta la funzionalità di interfacciamento con servizi LDAP.\footnote{Acrononimo per \inglese{Lightweight Directory Access Protocol}, è un protocollo \inglese{standard} per l'interrogazione e la modifica dei servizi di \inglese{directory} per la condivisione dei dati.\label{note:ldap}}
...
La versione base del \sw dispone, inoltre, del modulo \swname{User Experience}. Tale modulo permette all'azienda che adotta \progname, di disporre di due tipologie di interfacciamento: `utente semplice' e `amministratore'.
...
Infine, come anticipato in precedenza, \progname comprende la funzionalità di esecuzione automatica dei processi. Infatti, tramite il \inglese{deployment} dei processi è possibile automatizzarne l'esecuzione delle componenti che non devono essere gestite da risorse umane.
...
\medskip
\textbf{\sffamily{}Legenda:}
\medskip

\begin{tabular}{lp{\textwidth}}
\tick  & tale simbolo indica la disponibilità della funzionalità nella versione considerata\\
\cross & tale simbolo indica l'indisponibilità della funzionalità nella versione considerata\\
\end{tabular}
\end{minipage}
\end{small}
...
Un'ulteriore possibilità di estensione ottenibile tramite \inglese{plug-in} è l'integrazione con \swname{Microsoft Outlook} per gestire automaticamente l'invio delle notifiche ai collaboratori coinvolti nei processi aziendali. \progname consente infatti la gestione automatizzata dei processi che sono stati modellati attraverso l'\inglese{editor} grafico e l'invio delle notifiche	via \inglese{email} ai collaboratori.

Per quanto riguarda l'editor di diagrammi, riportato in figura \ref{fig:pmeditor}, sono da segnalare alcune carenze piuttosto rilevanti. In primo luogo, il modello di rappresentazione visuale dei processi utilizza una sintassi simile ai diagrammi di flusso o ai diagrammi di attività UML \footnote{acronimo di \inglese{Unified Modeling Language}, si tratta di un linguaggio di modellazione  basato sul paradigma \inglese{object-oriented}.} ma non rispetta lo \inglese{standard} BPMN e questo pone seri limiti all'interoperabilità con applicativi di terze parti.

\begin{figure}[H]
  \centering
  \includegraphics[width=.9\textwidth]{pm_editor}
  \caption{L'\inglese{editor} visuale dei processi interno a \progname.}
  \label{fig:pmeditor}
\end{figure}
...
\begin{itemize}
  \item \swname{Bizagi Process Modeler}, \inglese{editor} per la modellazione dei processi 
...
\subsubsection{Caratteristiche}
L'\inglese{editor} grafico è sufficientemente intuitivo e rispetta la notazione BPMN 2.0. Inoltre, l'interfaccia grafica ha un \inglese{look and feel} consistente con la applicazioni del sistema \swname{Windows}.
...
L'\inglese{editor} comprende anche la funzionalità di verifica dei diagrammi, che permette di fare il  \inglese{debugging} sui grafici prodotti. In figura \ref{fig:verifica} è riportato il messaggio restituito dal programma in seguito alla verifica effettuata.
...
\progname supporta inoltre l'integrazione con altre applicazioni, in particolare, tra le più importanti troviamo l'integrazione con gli \inglese{Enterprise Content Management} (ECM) come \swname{Sharepoint} e con gestionali \inglese{Customer Relationship Management} (CRM).

\progname permette la simulazione dei processi. In seguito ai \inglese{test} eseguiti, però, risulta essere più deludente rispetto a quella offerta da altri \sw presi in considerazione nel corso della presente analisi.
...
La documentazione fornita dal \inglese{team} di sviluppo è completa e comprende anche dei video \inglese{tutorial} di supporto. Purtroppo, sia la documentazione che i \inglese{tutorial} sono forniti solo in lingua inglese.

Inoltre, \progname mette a disposizione dei \inglese{process template}, che permettono agli utenti non esperti di avere la concezione delle potenzialità del programma.
...
\subsubsection{Descrizione}
\progname è una soluzione realizzata da un \inglese{team} di sviluppatori con sede a Berlino e distribuita sotto licenza \inglese{Apache v2.0} e quindi totalmente \inglese{open source}. Il \sw si basa sulla piattaforma \swname{Java} e sul \inglese{framework} per la realizzazione di soluzioni BPM \swname{Activiti}. 
...
\begin{tabular}{lp{\textwidth}}
\tick       & tale simbolo indica la disponibilità incondizionata della funzionalità cui si riferisce nel programma considerato\\
\tick$^{*}$ & i campi contrassegnati con questo simbolo si riferiscono a funzionalità che non sono disponibili nelle versioni di base dei programmi considerati ma solo nelle versioni a pagamento o previa sottoscrizione di un abbonamento\\
\cross & tale simbolo indica l'indisponibilità della funzionalità in questione nel programma considerato\\
n.\,p. & indica che la funzionalità non è pertinente per il \sw considerato, perché non rientra tra gli scopi per cui l'applicativo è stato concepito\\
\end{tabular}
\end{minipage}
\end{longtable}
\end{small}
...
Il costo della prestazione di consulenza ammonta pertanto a \textbf{\EUR{4.855,00}}. Pur essendo emerse delle problematiche nella realizzazione del progetto \team si è impegnata a mantenere inalterato il preventivo stabilito apportando come unica variazione la decurtazione del costo di redazione del manuale pari a \EUR{60,00} che non è stato realizzato per i problemi relativi al personale riscontrati. A tale proposito, si rimanda alla documentazione \inglese{online} e si consiglia, eventualmente, data la particolare completezza del manuale, di rivolgersi a un'agenzia di traduzioni.
