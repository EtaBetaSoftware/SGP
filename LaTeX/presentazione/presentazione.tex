...
\column{.5\textwidth}{
\begin{figure}
  \phantom{\includegraphics<1>[width=.9\textwidth]{markettrend}}
  \includegraphics<2->[width=.9\textwidth]{markettrend}
\end{figure}
}
\column{.5\textwidth}{
\begin{figure}
  \phantom{\includegraphics<1>[width=\textwidth]{worldmap3}}
  \includegraphics<2->[width=\textwidth]{worldmap3}
\end{figure}
}
\end{columns}
}
