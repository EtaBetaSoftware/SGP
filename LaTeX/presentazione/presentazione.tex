...
\begin{figure}
  \phantom{\includegraphics<1,2>[width=.7\textwidth]{logo}}
...
\begin{frame}% #1
\frametitle{Scomposizione gerarchica delle attività}
\begin{columns}
\column{.6\textwidth}{
\begin{enumerate}
  \item Pianificazione
...
\begin{frame}% #2
\frametitle{Organigramma aziendale}
