...
\begin{figure}
  \centering
  \phantom{\includegraphics<2>[width=.65\textwidth]{alpha}}
...
\begin{flushright}
\begin{tikzpicture}
  \path[thick,red,->] (0,0) edge[bend left] ++(2, .7);
\end{tikzpicture}
\end{flushright}
}
...
\column{.49\textwidth}{
\begin{figure}
  \phantom{\includegraphics<1>[width=.5\textwidth]{hardwork}}
...
\begin{columns}
\column{.5\textwidth}{
\begin{tabular}{m{.2\textwidth}m{.6\textwidth}}
\includegraphics[width=.18\textwidth]{biz_suite_logo} & Bizagi BPM Suite\\
\includegraphics[width=.18\textwidth]{biz_modeler_logo} & Bizagi Process Modeler\\
\end{tabular}
}
\column{.5\textwidth}{
\begin{alertblock}{\ding{56} Svantaggi:}
...
\column{.5\textwidth}{
\begin{figure}
  \includegraphics[width=.6\textwidth]{bonitasoft_logo}
\end{figure}
\begin{figure}
...
\begin{center}
\movie[externalviewer]{\includegraphics[width=.5\textwidth]{bonitasoft_logo}}{demo.wmv}
\end{center}
\end{frame}
\end{document}
