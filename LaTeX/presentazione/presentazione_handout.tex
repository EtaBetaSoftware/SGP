\documentclass[compress,9pt,handout]{beamer}
%*******************************************************************************
% Codifica e lingua
%*******************************************************************************
...
\begin{figure}
  \setlength{\fboxsep}{2pt}
  \fbox{\includegraphics[width=.9\textwidth]{logo}}
\end{figure}
...
\column{.49\textwidth}{
\begin{figure}
  \includegraphics[width=.5\textwidth]{hardwork}
\end{figure}
}
\end{columns}
\end{frame}
